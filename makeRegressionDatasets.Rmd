...
#host<-'127.0.0.1'
host<-'192.168.5.133'
fname<-'/Users/lptolik/Dropbox/Скальпель/DBData/RegressionMetaData.csv'
logname<-'/Users/lptolik/Dropbox/Скальпель/DBData/RegressionMetaData.log'
...
# Read table
```{r read.tbl}
metadata<-fread(fname,stringsAsFactors = FALSE)
