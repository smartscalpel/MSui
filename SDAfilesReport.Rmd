...
addEllipses=TRUE, ellipse.level=0.95)
fviz_pca_ind(pca, habillage=ff[idx[idx5]],
addEllipses=TRUE, ellipse.level=0.95)
```
...
corrplot(cv,main='CorrMatrix Diag/32', method="color",tl.pos='n',tl.cex=0.5,order ='original')
corrplot(cs,main='CosMatrix Diag/32', method="color",tl.pos='n',tl.cex=0.5,order ='original')
```
...
addEllipses=TRUE, ellipse.level=0.95)
fviz_pca_ind(pca, habillage=ff[idxMI[idx5]],
addEllipses=TRUE, ellipse.level=0.95)
```
...
fm<-featureMatrixMI[diag[idxMI]!=32,]
cv<-cor(t(fm))
cs<-lsa::cosine(t(fm))
```
...
corrplot(cv,main='CorrMatrix Diag/32 MI', method="color",tl.pos='n',tl.cex=0.5,order ='original')
corrplot(cs,main='CosMatrix Diag/32 MI', method="color",tl.pos='n',tl.cex=0.5,order ='original')
```
