--
-- Файл сгенерирован с помощью SQLiteStudio v3.0.7 в Wed Sep 14 10:53:54 2016
--
...
-- Таблица: Sample
CREATE TABLE Sample ( TumorID integer(10) NOT NULL, TumorPatientID integer(10) NOT NULL, ID integer(10) NOT NULL, Coords varchar(255), Histology varchar(4000), PRIMARY KEY (TumorID, TumorPatientID, ID), FOREIGN KEY(TumorID, TumorPatientID) REFERENCES Tissue(ID, PatientID))
...
-- Таблица: Patient
CREATE TABLE Patient ( ID INTEGER NOT NULL PRIMARY KEY, EMSID varchar(255) NOT NULL, YOB integer(10) NOT NULL CHECK (YOB > 1900 AND YOB < 2100), Sex char(1) CHECK (Sex = 'M' OR Sex='F'))
