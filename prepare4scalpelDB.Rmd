...
```{r save.sig}
save(spectra,origSpectra,ncMD,devID,solID,isID,resID,smplID,stID,stpID,rangeID,nMode,cdf.file,cdf.fname,file = 'spectra.RData')
...
system.time(res<-sapply(fpeaks2,writeDTpeak,specID=basename(cdf.fname),tic=tic,fname=peakFname))
```
