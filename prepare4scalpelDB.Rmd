...
mdL<-lapply(intRT,function(.x)list(Polarity=as.character(protocol$Polarity[.x]),
                                   Detector=as.character(protocol$Detector[.x]),
                                   Range=as.character(protocol$Range[.x]),
                                   protocol=paste(protocol$Polarity[.x],
                                                  protocol$Detector[.x],
                                                  protocol$Range[.x],sep = '.')))
tic<-sapply(spectra,totalIonCurrent)
