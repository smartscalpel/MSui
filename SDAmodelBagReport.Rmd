...
pred.agg.fm<-do.call(rbind,
                     lapply(unique(md[,anName]),
                       aggregatePredictions,
                       matr=predict.fm,
                       annot=md[,anName],
                       fun=aggFun))
pred.agg.md<-as.data.frame(do.call(rbind,
                     lapply(unique(md[,anName]),
                            aggregatePredictions,
                            matr=md,
                            annot=md[,anName],
                            fun=function(.x){.x[1]})))
pred.agg.md$diag<-factor(pred.agg.md$diagnosis,levels=c(32,l[l!=32]),ordered=TRUE)
agg.cls<-pred.agg.md$diag
train.agg.fm<-do.call(rbind,
                     lapply(unique(train.md[,anName]),
                       aggregatePredictions,
                       matr=train.fm,
                       annot=train.md[,anName],
                       fun=aggFun))
train.agg.md<-as.data.frame(do.call(rbind,
                     lapply(unique(train.md[,anName]),
                            aggregatePredictions,
                            matr=train.md,
                            annot=train.md[,anName],
...
train.agg.md$diag<-factor(train.agg.md$diagnosis,levels=c(32,l[l!=32]),ordered=TRUE)
train.agg.cls<-train.agg.md$diag
train.best<-list()
test.best<-list()
```
```{r base.stat.plots}
qplot(as.character(agg.cls),log='y')
pander(table(agg.cls))
...
df<-cbind(pred.agg.md,as.data.frame(pred.agg.fm))
pldf<-melt(df,id=names(pred.agg.md))
...
sfm<-t(scale(t(pred.agg.fm),scale = rowSums(pred.agg.fm)/1e6,center = FALSE))
sdf<-cbind(pred.agg.md,as.data.frame(sfm))
spldf<-melt(sdf,id=names(pred.agg.md))
...
sfm<-t(scale(t(pred.agg.fm),scale = rowMax(pred.agg.fm)/1e6,center = FALSE))
sdf<-cbind(pred.agg.md,as.data.frame(sfm))
spldf<-melt(sdf,id=names(pred.agg.md))
spldf$mz<-round(as.numeric(as.character(spldf$variable)),4)
...
pca<-try(prcomp(pred.agg.fm,scale. = FALSE),silent=TRUE)
if(class(pca)!="try-error"){
  ...
  fviz_pca_ind(pca, habillage='none',label = 'none',axes=c(1,3),
               addEllipses=FALSE)
  fviz_pca_ind(pca, habillage=pred.agg.md$diag,
               addEllipses=TRUE, ellipse.level=0.95)
  fviz_pca_ind(pca, habillage=pred.agg.md$diag,axes=c(1,3),
               addEllipses=TRUE, ellipse.level=0.95)
}else{
...
pca<-prcomp(pred.agg.fm[,which(apply(pred.agg.fm,2,sd)>0)],scale. = TRUE)
fviz_screeplot(pca, ncp=15)
fviz_pca_ind(pca, habillage='none',label = 'none',
             addEllipses=FALSE)
fviz_pca_ind(pca, habillage='none',label = 'none',axes=c(1,3),
...
M<-do.call(cbind,train.probL.dda.full)
agg.M<-do.call(rbind,
                     lapply(unique(train.md[,anName]),
                       aggregatePredictions,
                       matr=M,
                       annot=train.md[,anName],
                       fun=aggFun))
train.probM.dda.full<-agg.M

train.auc<- caTools::colAUC(train.probM.dda.full,train.agg.cls,plotROC = TRUE)
...
M<-do.call(cbind,probL.dda.full)
agg.M<-do.call(rbind,
                     lapply(unique(md[,anName]),
                       aggregatePredictions,
                       matr=M,
                       annot=md[,anName],
                       fun=aggFun))
probM.dda.full<-agg.M
auc<- caTools::colAUC(probM.dda.full,agg.cls,plotROC = TRUE)
...
t<-data.frame(probII=train.probM.dda.full[,idxBest],
              diag=as.character(train.agg.cls))
...
p<-data.frame(probII=probM.dda.full[,idxBest],
              diag=as.character(agg.cls))
...
M<-do.call(cbind,train.probL.dda.top20)
agg.M<-do.call(rbind,
                     lapply(unique(train.md[,anName]),
                       aggregatePredictions,
                       matr=M,
                       annot=train.md[,anName],
                       fun=aggFun))
train.probM.dda.top20<-agg.M
train.auc<- caTools::colAUC(train.probM.dda.top20,train.agg.cls,plotROC = TRUE)
...
M<-do.call(cbind,probL.dda.top20)
agg.M<-do.call(rbind,
                     lapply(unique(md[,anName]),
                       aggregatePredictions,
                       matr=M,
                       annot=md[,anName],
                       fun=aggFun))
probM.dda.top20<-agg.M
auc<- caTools::colAUC(probM.dda.top20,agg.cls,plotROC = TRUE)
...
t<-data.frame(probII=train.probM.dda.top20[,idxBest],
              diag=as.character(train.agg.cls))
...
p<-data.frame(probII=probM.dda.top20[,idxBest],
              diag=as.character(agg.cls))
...
M<-do.call(cbind,train.probL.dda.top10)
agg.M<-do.call(rbind,
                     lapply(unique(train.md[,anName]),
                       aggregatePredictions,
                       matr=M,
                       annot=train.md[,anName],
                       fun=aggFun))
train.probM.dda.top10<-agg.M
train.auc<- caTools::colAUC(train.probM.dda.top10,train.agg.cls,plotROC = TRUE)
...
M<-do.call(cbind,probL.dda.top10)
agg.M<-do.call(rbind,
                     lapply(unique(md[,anName]),
                       aggregatePredictions,
                       matr=M,
                       annot=md[,anName],
                       fun=aggFun))
probM.dda.top10<-agg.M
auc<- caTools::colAUC(probM.dda.top10,agg.cls,plotROC = TRUE)
...
t<-data.frame(probII=train.probM.dda.top10[,idxBest],
              diag=as.character(train.agg.cls))
...
p<-data.frame(probII=probM.dda.top10[,idxBest],
              diag=as.character(agg.cls))
...
M<-do.call(cbind,train.probL.lda.full)
agg.M<-do.call(rbind,
                     lapply(unique(train.md[,anName]),
                       aggregatePredictions,
                       matr=M,
                       annot=train.md[,anName],
                       fun=aggFun))
train.probM.lda.full<-agg.M
train.auc<- caTools::colAUC(train.probM.lda.full,train.agg.cls,plotROC = TRUE)
...
M<-do.call(cbind,probL.lda.full)
agg.M<-do.call(rbind,
                     lapply(unique(md[,anName]),
                       aggregatePredictions,
                       matr=M,
                       annot=md[,anName],
                       fun=aggFun))
probM.lda.full<-agg.M
auc<- caTools::colAUC(probM.lda.full,agg.cls,plotROC = TRUE)
...
t<-data.frame(probII=train.probM.lda.full[,idxBest],
              diag=as.character(train.agg.cls))
train.best[['lda.full']]<-t$probII
...
p<-data.frame(probII=probM.lda.full[,idxBest],
              diag=as.character(agg.cls))
...
M<-do.call(cbind,train.probL.lda.top20)
agg.M<-do.call(rbind,
                     lapply(unique(train.md[,anName]),
                       aggregatePredictions,
                       matr=M,
                       annot=train.md[,anName],
                       fun=aggFun))
train.probM.lda.top20<-agg.M
train.auc<- caTools::colAUC(train.probM.lda.top20,train.agg.cls,plotROC = TRUE)
...
M<-do.call(cbind,probL.lda.top20)
agg.M<-do.call(rbind,
                     lapply(unique(md[,anName]),
                       aggregatePredictions,
                       matr=M,
                       annot=md[,anName],
                       fun=aggFun))
probM.lda.top20<-agg.M
auc<- caTools::colAUC(probM.lda.top20,agg.cls,plotROC = TRUE)
...
t<-data.frame(probII=train.probM.lda.top20[,idxBest],
              diag=as.character(train.agg.cls))
...
p<-data.frame(probII=probM.lda.top20[,idxBest],
              diag=as.character(agg.cls))
...
M<-do.call(cbind,train.probL.lda.top10)
agg.M<-do.call(rbind,
                     lapply(unique(train.md[,anName]),
                       aggregatePredictions,
                       matr=M,
                       annot=train.md[,anName],
                       fun=aggFun))
train.probM.lda.top10<-agg.M
train.auc<- caTools::colAUC(train.probM.lda.top10,train.agg.cls,plotROC = TRUE)
...
M<-do.call(cbind,probL.lda.top10)
agg.M<-do.call(rbind,
                     lapply(unique(md[,anName]),
                       aggregatePredictions,
                       matr=M,
                       annot=md[,anName],
                       fun=aggFun))
probM.lda.top10<-agg.M
auc<- caTools::colAUC(probM.lda.top10,agg.cls,plotROC = TRUE)
...
t<-data.frame(probII=train.probM.lda.top10[,idxBest],
              diag=as.character(train.agg.cls))
...
p<-data.frame(probII=probM.lda.top10[,idxBest],
              diag=as.character(agg.cls))
test.best[['lda.top10']]<-p$probII
lda.top10.roc.pred<-roc(p$diag,p$probII,
                  smoothed = TRUE,ci=TRUE, 
                  ci.alpha=0.9, 
                  stratified=FALSE,plot=TRUE, 
                  auc.polygon=TRUE, max.auc.polygon=TRUE, 
...
M<-do.call(cbind,train.probL.lasso.full)
agg.M<-do.call(rbind,
                     lapply(unique(train.md[,anName]),
                       aggregatePredictions,
                       matr=M,
                       annot=train.md[,anName],
                       fun=aggFun))
train.probM.lasso.full<-agg.M
train.auc<- caTools::colAUC(train.probM.lasso.full,train.agg.cls,plotROC = TRUE)
...
M<-do.call(cbind,probL.lasso.full)
agg.M<-do.call(rbind,
                     lapply(unique(md[,anName]),
                       aggregatePredictions,
                       matr=M,
                       annot=md[,anName],
                       fun=aggFun))
probM.lasso.full<-agg.M
auc<- caTools::colAUC(probM.lasso.full,agg.cls,plotROC = TRUE)
...
t<-data.frame(probII=train.probM.lasso.full[,idxBest],
              diag=as.character(train.agg.cls))
...
p<-data.frame(probII=probM.lasso.full[,idxBest],
              diag=as.character(agg.cls))
...
M<-do.call(cbind,train.probL.lasso.top20)
agg.M<-do.call(rbind,
                     lapply(unique(train.md[,anName]),
                       aggregatePredictions,
                       matr=M,
                       annot=train.md[,anName],
                       fun=aggFun))
train.probM.lasso.top20<-agg.M
train.auc<- caTools::colAUC(train.probM.lasso.top20,train.agg.cls,plotROC = TRUE)
...
M<-do.call(cbind,probL.lasso.top20)
agg.M<-do.call(rbind,
                     lapply(unique(md[,anName]),
                       aggregatePredictions,
                       matr=M,
                       annot=md[,anName],
                       fun=aggFun))
probM.lasso.top20<-agg.M
auc<- caTools::colAUC(probM.lasso.top20,agg.cls,plotROC = TRUE)
...
t<-data.frame(probII=train.probM.lasso.top20[,idxBest],
              diag=as.character(train.agg.cls))
...
p<-data.frame(probII=probM.lasso.top20[,idxBest],
              diag=as.character(agg.cls))
...
M<-do.call(cbind,train.probL.lasso.top10)
agg.M<-do.call(rbind,
                     lapply(unique(train.md[,anName]),
                       aggregatePredictions,
                       matr=M,
                       annot=train.md[,anName],
                       fun=aggFun))
train.probM.lasso.top10<-agg.M
train.auc<- caTools::colAUC(train.probM.lasso.top10,train.agg.cls,plotROC = TRUE)
...
M<-do.call(cbind,probL.lasso.top10)
agg.M<-do.call(rbind,
                     lapply(unique(md[,anName]),
                       aggregatePredictions,
                       matr=M,
                       annot=md[,anName],
                       fun=aggFun))
probM.lasso.top10<-agg.M

auc<- caTools::colAUC(probM.lasso.top10,agg.cls,plotROC = TRUE)
...
t<-data.frame(probII=train.probM.lasso.top10[,idxBest],
              diag=as.character(train.agg.cls))
...
p<-data.frame(probII=probM.lasso.top10[,idxBest],
              diag=as.character(agg.cls))
...
combine_res<-as.data.frame(
  matrix(0,ncol=length(scheme),
         ...
         dimnames = list(c('train','test'),
                         scheme)))
train_err<-sapply(train.best,getRMSD,obs=train.agg.cls)
test_err<-sapply(test.best,getRMSD,obs=agg.cls)
...
for (i in scheme) {
  combine_f[[i]] <- Forecast_comb(obs = (as.numeric(train.agg.cls)-1),
                                  fhat = m.train,
                                  fhat_new=m.test,
                                  Averaging_scheme = i)
  combine_res[1,i] <- round(
    sqrt(mean((combine_f[[i]]$fitted - 
            (as.numeric(train.agg.cls)-1))^2)), 
    3)
  combine_res[2,i] <- round(
    sqrt(mean((combine_f[[i]]$pred - 
                 (as.numeric(agg.cls)-1))^2)), 
    3)
}
pander(ind_err)
pander(combine_res)
